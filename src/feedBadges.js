/**
 * Feed momentum rozetleri — tek sınıflandırma, öncelik: DUMP > ATH > HOT.
 * DUMP varken ATH/HOT asla dönmez.
 */
...
function metrics(item) {
  ...
  /** Büyük 24s pump sonrası kısa vadede satış (klasik dump). */
  const pumpThenDump =
